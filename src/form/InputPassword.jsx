...
export const InputPassword = ({ name, label, message, parseInput }) => {
    ...
    const validated = (value) => {
        if (inputReducer('password', value))
            return true;
        else
            return false
    }
    ...
    return (
        <div className={clases.inputCotainer} ref={ref}>
            ...
            {
                !value.ok 
                ? <> <p>{message}</p> <i className='fas fas-times'></i> </>
